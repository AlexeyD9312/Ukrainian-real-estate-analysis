# Аналіз ринку житлової нерухомості України
## Цілі проекту
Аналіз  ринку житлової нерухомості України. Дослідити динаміку цін та кількості пропозицій на ринку за останні 7 років. Оцінити стан ринку на даний момент. Розглянути інвестиційну привабливість нерухомості в Украіні. Дослідити, на прикладі м.Дніпро, яка саме нерухомість найбільш цікава покупцям на даний момент.
...
## Збір даних для аналізу середньої вартості житлової нерухомості по Україні.
...
Це частина стандартнго запиту, в якому вказані параметри, ключ та URL. Відповідь буде дана у вигляді JSON файлу[Приклад відповіді](./data/1AVG_PRICE_SALE_RENT.json), з зазначеною вартістю нерухомості та кількістю об'єктів. Це корисна інформація, але для оцінку вартості нерухомості дуже важливо мати ціну за 1 квадратний метр. Тому ми будемо окремо робити запити на кожну задану площу(була взята вибірка найбільш популярних площ квартир).У подальшому отримана ціна  буде поділена на площу вказану у запиті. Це дозволить в кінці вирахувати середню вартість за метр, по кожному місту, в діапазоні заданих дат. 
Категорії "category" та "sub_category" відповідають за тип нерухомості - це житлова нерухомість, квартири.
Операція 1 - продаж. Також додаємо дату початку та дату кінця дослідження, інтервал запиту - 1 місяць. Формуємо список з ID міст.  Та не забуваємо про паузи між запитами, адже даний сервіс має обмеження в 2000 запитів на годину.
...
## Візуалізація та аналіз середньої вартості житлової нерухомості України
---
...
Одразу кидається в очі розрив у графіку на початку 2022 року, це пов'язано з початком бойових дій на территорії України. У зв'язку з цими подіями було призупинено роботу реєстрів нерухомості,та ринку вцілому. Після відновлення роботи реєстрів,  ми спостерігаємо невелику анамомалію у вигляді стрибка цін на короткий період. Це було викликано штучно, через "надування" цін у деяких містах. Але вже на початку осені 2022 року ми бачимо нормалізацію ринку і цін.
Далі до весни 2024 року ми бачимо постійне зростання цін, майже на 30%, і корельване зростання кількості пропозицій. Також хочу акцентувати увагу, що кількість пропозицій - це не кількість реальних угод, інформації по кількості угод немає у відкритому доступі, цю проблему ми будемо намагатися мінімізувати у майбутньому.   

Якщо зростання кількості пропозицій було прогнозоване, через міграційні процеси, то зростанням ціни - питання більш складне. Лідируючий сегмент у формуванні цін на ринку нерухомості - ринок первинного житла. За останні 3 роки ми можемо спостерігати постійне зростання цін на сировину та будівельні матеріали, в залежності від сегменту, від 40 до 80 %. Цей фактор змушує забудовників збільшувати ціну за свої об'єкти. Власники квартир та інвестори теж , відчуваючі на собі інфляційні процеси, підтягують ціни, у відсотковому співвідношенні, на свої об'єкти відносно новобудов. У якості експеременту додамо графік вартості нерухомості у еквіваленті золота, адже відсоткове здорожчання золота добре корелює зі здорожченням вартості будівельних матеріалів.

![image Alt Text](./vizualization/images_3.bmp)
---

Тобто покупці спостерігають зростання цін на нерухомості у долларі. Продавці, в свою чергу, розуміючи реальну собіварть об'єктів, відмовляються стримувати зростання цін, що призводить до конфлікту інтересів покупця та продавця на ринку. Цей процесс ми чітко спостерігаємо на графіку у другому кварталі 2024 року, у вигляді  різкого скорочення кількості нових об'єктів,вимушене зниження цін, та стагнації ринку уцілому.
...
Далі розглянемо дашборд з мапою України, на якому буде зображена середня вартість нерухомості, візуалізована кількість пропозицій, та середній строк окупності, який ми отримали поділивши середню вартість об'єкта на середню вартість оренди. Оберемо період за останні 5 років.
...
Звісно останній показник - експерементальний, але він відображає інфляційні процесси долара відносно вартості сировини, будівельних матеріалів, та реальної собівартість житла.

На цьому єтапі ми можемо дослідити динаміку цін у кожному обласному центрі України, оцінити інвестиційну привабливість нерухомості, як для продавця так і для покупця. Прогнозовано, що нерухомість у містах на сході втратила свою вартість. В той час як на заході, навпаки, ціна виросла. До цього додається строк окупності від оренди та ризики пов'язані з бойовими діями. За сукупністі цих факторів можна розглянути інвестиційну привабливість, стан ринку, для прийняття рішень з покупки або продажу житлової нерухомості.

Раніше у роботі вже підіймалося питання про відсутність показника кількості  реальних угод з продажу квартир. Нажаль ці дані відсутні у відкритому доступі, що ускладнює реальну оцінку стану ринку нерухомості. Цю проблему ми спробуємо мінізувати у наступних кроках.

## Збір даних для аналізу середньої вартості житлової нерухомості, та вподобання покупців по місту Дніпро.
...
Зробивши запит на конкретне ID оголошення сайту DIM.RIA, ми отримаємо відповідь в вигляді JSON файлу з подібним описом квартири, починаючи від локації, фізичних характепистик , закінчуючи інформацією про продавця. Тож розглянемо процесс отримання цих даних.
...
```
 ...
 Тепер робимо запит по кожному ID. [код запиту](./pyton_scripts/parce_all_obj_Dnipro.py)  ми отримуємо JSON файли з повним описом і характеристикою об'єкту. [Файл з характеристикою квартири](./data/0000_30429057_ID.json). Зберігаємо усі 7600 файлів в окрему папку.
 Вивчаємо документацію API, ключі словника, та починаємо виділяти та зберігати в окремі CSV файли  потрібнібні нам параметрами, для формування реляційної Бази Даних. 
 ...
 Додатково кожний файл з характеристикою квартири має URL посилання на сторінку об'ви на сайті DIM.RIA. Перейшовши за цим посиланням, ми опиняємось на сторінці оголошення , де ми можемо спостерігати загаліну кількість переглядів користувачів, та додавань об'яв у список користувача. Нажаль ці параметри не надаються у відповіді API сервісу, адже ці дані дають нам змоги виявити реальну зацікавленість покупців у тому чи іншому об'єкті. Це дозволить нам частково компенсувати відсутність інформації по кількості угод у нашому аналізі. Тож починаємо збирати ці дані для кожного обєкту. Для цього використовуємо бібліотек Python BeautifulSoup, яка дозволяє нам парсити данні використовуючи HTML сторінки. Базова структура сторінки є статичною. А от кількість переглядів і додавань є динамічним контентом. Тому додатково долучаємо бібліотеку Selenium.
 Вона дозволить нам імітувати відвідування сайту користувачем, що дозволить зібрати потрібні дані. [Код з бібліотекою Selenium ](./pyton_scripts/views_added_for_pause.py)  Паралельно збираємо інші дані та отримуємо файл для нашої БД.  [Файл з кількістю переглядів](./data/Total_views_check.csv)
...
```
Також створюємо view в якому будуть вказані кількість переглядів та додавань. Також створюємо стовпець який буде характеризувати ЗАЦІКАВЛЕНІСТЬ КОРИСТУВАЧІВ, коєфіцієнт зацікавленості. Ми отримуємо його поділивши кількість додавань на перегляди та помноживши на 100. Також враховуємо дату сворення об'яви, адже більш свіжі об'яви мають трохи інші показники в порівнянні зі сталими. Виділяємо 3 категорії "low" , "normal", "hight". Цей коефіцієнт є суб'єктивним, заснований на моєму власному досвіді, який варто доопрацьовувати, але він виконає основну задачу - відсіє "холодні" оголошення, які взагалі не цікаві користувачам. Завантажуємо данні з наших view у PowerBi, встановлюємо зв'язки та отримуємо наступний дашборд.

## Візуалізація та аналіз середньої вартості житлової нерухомості, та вподобань покупців міста Дніпро

![image Alt Text](./vizualization/view.bmp)
---

На даний момент, початок березня, ми спостерігаємо у м. Дніпро - 4176 квартир у продажу. З середньою вартісю в 943$ за метр, та 59000 $ за об'єкт вцілому.
Звісно ціни дуже різняться в залежності від району. Так в центральних районах ціна за квадрат вища більш ніж на 30%, в порівнянні з більш віддаленими, а вартість об'єкту вцілому , відрізняється майже на 100%. На круговій діаграмі ми спостерігаємо відсоткову частку об'єктів по кожному району. З 9 районів, 3 райони центральної частини міста, займають більше 50% ринку по місту.
Також, за допомогою фільтрів, ми можемо більш детально переглянути статистику по кожному району, обравше рік будівництва, площу, можливість кредетуання та тип угоди.
І головне. спробуємо використати наш "коефіцієнт зацікавленості", який ми отримали за допомогою інформації про кількість переглядів та додавань. Ми маємо 3 категорії:"low" - низька зацікавленість , "normal" - середня, "hight" - висока. Обравши категорію "low", тобто об'яви які майже ніхто не переглядає та не цікавиться, ми отримуємо 2537 об'єктів, це більше ніж 60% ринку. Ціна цих об'єктів вища за середню по ринку на 5% та 10% , за метр та об'єкт відповідно.
Обравши 2 категорії "normal" - середня та "hight" - висока, ми отримуємо залишок у 1639 об'єктів(40% ринку). Отримаємо середню вартість, за квадратний метр та об'єкт, нищу на 10% та 12% відповідно.
І обравши лише категорію "hight", ми отримали лише 54 об'єкта. Середня вартість метра квадратного складає 769$, що на 20% нижче ніж середня, а середня вартість об'єкту склала - 43000$, що на 30% нижче середньої.
Розглянемо більш детально ці об'єкти.

![image Alt Text](./vizualization/table.bmp)
---

Ми спостерігаємо наявність у вибірці всіх районів, є більший попит на віддалені райони міста, адже там нижча ціна. Також ми спостерігаємо різні роки будівництва. Наявность кредитних програм не сильно вплинула на попит. Нам трапляються і новобудови з ремонту та без, об'єкти вторинного ринку з різним станом ремонту. Але головний фактор, який найбільше впливає на зацікавленість покупця - низька ціна. Низька ціна як у цілому за об'єкт, так і за квадратний метр. Так ми спостерігаємо і доволі дорогі об'єкти, але зайшовши на сайт ми бачимо дуже гарне співвідношення ціни та якості, тобто коли реальна собівартість житла перевищує нинішню ціну об'єкту.
Тому робимо висновок, що ринок нерухомості у м. Дніпра, як і ринок України (за даними з сайту DIM.RIA) - стагнує. Його більша частка - 60%, практично не привертає увагу покупців. А реально активних оголошень - трохи більше 1%, і то за умови гарного дисконту у 20-30% від середньої вартості нерухомості. Звісно ситуація, прогнозовано, залежить і від регіону. Але спостерігаючи різке зниження пропозицій всередині 2024 року, на ринку України , робимо висновок що ситуація на ринку нерухомості міста Дніпра,  корелює з ситуацією на ринку країни вцілому.
 
[Посилання на звіт PowerBi](https://app.powerbi.com/groups/me/reports/346c1a4c-3a1e-4ca3-8b8a-82ed5ab276db/28d87f3f752b70c8a8bb?experience=power-bi)
