...
```
 [Повний код](./oll_Dnipro_ID.py)

 У відповідь ми отримуємо JSON файл, який містить загальну кількість об'єктів та список із 100 ID цих об'єктів. [Файл](./Kiyiv_ID.py)
 ...
 Тепер робимо запит по кожному ID. [код запиту](./parse_all_obj_Dnipro.py)  ми отримуємо JSON файл з повним описом і характеристикою об'єкту. [Файл з характеристикою квартири](./0000_30429057.py). Зберігаємо усі 7600 файлів в окрему папку.
 ...
 З прикладом збору інформації та іі зберігання можна детальніше ознайомитись тут  [Код](./general_characteristics_to_csv.py)   [Отриманий файл](./general_characteristics.csv) 
 ...
 Вона дозволить нам імітувати відвідування сайту користувачем, що дозволить нам зібрати потрібні дані. [Код з бібліотекою Selenium ](./views_added_for_pause.py)
 Паралельно збираємо інші дані та отримуємо файл для нашої БД.  [Файл з характеристикою квартири](./0000_30429057.py)
